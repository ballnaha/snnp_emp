...
export default function NewStaffPage() {
    ...
    const handleDownload = async () => {
        ...
        try {
            ...
            link.download = `badge_${formData.emp_id || 'new'}_${formData.en_firstname || 'staff'}.png`;
            link.href = image;
            link.click();
                    ...
                    <Box sx={{ flex: 1 }}>
                        ...
                        <Paper sx={{
                            ...
                            <Box sx={{
                                ...
                                <Box sx={{
                                    width: 350, // ปรับให้สัมพันธ์กับ 5.5 ซม.
                                    height: 547, // ปรับให้สัมพันธ์กับ 8.6 ซม. (350 * 8.6 / 5.5)
                                    position: 'relative',
                                    borderRadius: '18px', // ขอบมนของบัตร RFID มาตรฐาน
                                    overflow: 'hidden',
                                ...
                                >
                                    ...
                                    <Box sx={{
                                        width: '100%',
                                        height: 73, // ~1.3cm (547 / 8.6 * 1.3)
                                        mt: 0.5, // เพิ่มระยะห่างจากขอบบนเล็กน้อย
                                    ...
                                    <Box sx={{
                                        width: '100%',
                                        height: 127, // ~2cm (547 / 8.6 * 2)
                                        backgroundImage: 'url(/api/uploads/card/card_footer.png)',
                                        backgroundSize: 'cover', // Use cover for footer to ensure the red background fills the area
                                        backgroundPosition: 'center',
                                        backgroundRepeat: 'no-repeat',
                                        flexShrink: 0,
                                        position: 'relative',
                                        ...
                                        <Box sx={{ flex: 1, color: '#FFF' }}>
                                            <Typography sx={{
                                                ...
                                                whiteSpace: 'nowrap',
                                                overflow: 'visible', // ยอมให้สระล้นออกมาได้
                                            }}>
                                        ...
                                        <Box sx={{
                                            width: 127, // ความสูงเท่ากับ Footer
                                            height: 127,
                                            bgcolor: '#FFF',
                                            p: 0.5, // เพิ่ม padding เล็กน้อยตามสั่ง
                                            display: 'flex',
                                            justifyContent: 'center',
                                            alignItems: 'center',
                                        }}>
                        ...
                        <Box sx={{
                            ...
                            <Button
                                ...
                                variant="contained"
                                disabled={loading}
                                startIcon={loading ? <CircularProgress size={18} color="inherit" /> : <Save2 size={20} variant="Bold" color="#fff" />}
                                sx={{
                                    borderRadius: '12px',
                                    bgcolor: '#1E293B',
                                    px: 4,
                            ...
                            >
                                {loading ? 'กำลังบันทึกข้อมูล...' : 'บันทึกข้อมูลพนักงาน'}
                            </Button>
                        </Box>
                    </Box>
                </Box>
